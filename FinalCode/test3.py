...
GIFPlay.start()
time.sleep(3)
play_audio(Path("Welcome.mp3"))
time.sleep(2)
play_audio(Path("processing.mp3"))
#============================================================================================
for _ in range(10):
    AnimationNumber = 4
    envkey= f"ANIMATION_PATH{AnimationNumber}"
